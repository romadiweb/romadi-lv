insert into public.pricing_plans (
  service_key, name, price_prefix, price_label, description, features, cta_label,
  cta_href, sort_order, is_featured, is_published
)
values
  ('interneta-veikalu-izstrade', 'Pamata veikals', 'Sākot no', '1 200 €',
   ...
   'Pārrunāt pamata veikalu', null, 10, false, true),
  ('interneta-veikalu-izstrade', 'Izaugsmes veikals', 'Sākot no', '2 400 €',
   ...
   'Pārrunāt izaugsmes veikalu', null, 20, true, true),
  ('interneta-veikalu-izstrade', 'Individuāla e-komercija', 'Sākot no', '4 200 €',
   ...
   'Pārrunāt individuālu veikalu', null, 30, false, true);;
